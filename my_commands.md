...
```
```sh
python tools/analysis_tools/analyze_logs.py plot_curve work_dirs/rhino_phc_haus-4scale_swint_2xb2-36e_gen_delhi_CG_bks/20250411_025330/vis_data/20250411_025330.json --keys loss_cls loss_bbox loss_iou --legend Classification_Loss Bounding_Box_Loss IOU_Loss --title Loss_Curves --out gen_delhi_to_wb_loss_plot.png
```